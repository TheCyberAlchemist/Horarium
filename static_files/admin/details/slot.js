...
function return_row(slot) {
	...
	var add_here = document.createElement("td");
	// edit.innerHTML = '<img class=\"action_icons edit\" src = ' + pen_link + ' alt=pen title=\"Edit\" ></img>';
	add_here.innerHTML = '<i class="fas fa-update add_here"></i>';
	add_here.className = "border-0 edit_buttons";
	tr.appendChild(add_here);
	return tr;
}
